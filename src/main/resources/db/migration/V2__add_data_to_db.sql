insert into client(firstname, lastname, patronymic, date_of_birth, email, phone_number, created_at, updated_at, frozen,
                   is_delete, is_verify)
values ('Игорь', 'Солод', 'Дмитрьевич', cast('1990/05/28' as date), 'igorSovol@1990.ru', '8802552225',
        cast('2015/05/16' as date), cast('2015/05/16' as date), false,
        false, false),
       ('Татьяна', 'Заречка', 'Ивановна', cast('1989/01/01' as date), 'tanuySovet@98.ru', '8802511100',
        cast('2020/01/10' as date), cast('2021/05/16' as date), false,
        false, true),
       ('Михаил', 'Цверг', 'Степанович', cast('1984/05/28' as date), 'mishaCherg@2001.ru', '88002220033',
        cast('2021/01/10' as date), cast('2021/01/10' as date), false,
        false, true),
       ('Светлана', 'Одуван', 'Васильевна', cast('1952/11/28' as date), 'odyvanSvets@52.ru', '8802552200',
        cast('2022/05/16' as date), cast('2022/05/16' as date), false,
        false, true),
       ('Дмитрий', 'Медведев', 'Дмитрьевич', cast('1979/05/04' as date), ' BearDmitrya@79.ru', '8802552211',
        cast('2023/01/10' as date), cast('2023/01/10' as date), false,
        false, false);
...
values ('перевод', 'отправление денег с активного счета'),
