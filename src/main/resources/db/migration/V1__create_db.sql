...
create table if not exists country (
    ...
    document_format integer not null references document_format ) ;
...
create table if not exists client (
    ...
    email varchar not null constraint client_pk unique,
...
create table if not exists document (
    client_id integer not null primary key references client on delete cascade,
     document_number varchar(50) not null constraint document_pk unique,
